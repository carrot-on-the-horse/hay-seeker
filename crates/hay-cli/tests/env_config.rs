...
const ISOLATED_ENV_VARS: &[&str] = &[
    ...
    "COTH_HAY_SEEKER_CLOUDFLARE_WORKERS_AI_MODEL",
    ...
    "COTH_HAY_SEEKER_GEMINI_QUERY_TASK",
    "COTH_HAY_SEEKER_GEMINI_SMOKE_CHUNK_TOKENS",
    "COTH_HAY_SEEKER_LOCAL_MODEL_DIR",
    "COTH_HAY_SEEKER_LOCAL_RESEARCH_DUCKDB_DIMENSIONS",
    ...
    "COTH_HAY_SEEKER_RERANK_MAX_ATTEMPTS",
    ...
    "COTH_HAY_SEEKER_VOYAGE_RERANK_MODEL",
